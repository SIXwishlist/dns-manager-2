    ...
    <div class="col-md-12">
      <div class="panel panel-default panel-border-color panel-border-color-primary">
        ...
        <div class="panel-body">
          ...
          <form role="form" method="POST" name="myform" action="{{ route('post::store') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group xs-pt-10{{ $errors->has('order') ? ' has-error' : '' }}">
              ...
              <input id="order" type="number" class="form-control" name="order" value="{{ old('order') }}" required autofocus>
